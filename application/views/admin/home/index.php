...
<div class="wrapper">
    <div class="widgets">
        ...
        <div class="widget">
            <div class="title">
                <span class="titleIcon"><div class="checker" id="uniform-titleCheck"><span><input type="checkbox"
                                                                                                  id="titleCheck"
                                                                                                  name="titleCheck"
                                                                                                  style="opacity: 0;"></span></div></span>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="21"
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="20"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="19"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="18"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="17"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="16"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="15"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="14"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="13"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" name="id[]" value="12"
                                                                                 style="opacity: 0;"></span></div>
                    </td>
