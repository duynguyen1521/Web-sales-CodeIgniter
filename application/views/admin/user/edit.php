        ...
        <fieldset>
            <div class="widget">
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="name" id="param_name" _autocheck="true" type="text" value="<?php echo $user->name; ?>">
                        </span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="email" id="param_email" _autocheck="true" type="text" value="<?php echo $user->email; ?>">
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="phone" id="param_phone" _autocheck="true" type="text" value="<?php echo $user->phone; ?>">
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="address" id="param_address" _autocheck="true" type="text" value="<?php echo $user->address; ?>">
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
