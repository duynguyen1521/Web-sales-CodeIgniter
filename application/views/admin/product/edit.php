                ...
                <div class="tab_container">
                    <div id="tab1" class="tab_content pd0">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    <img src="<?php echo base_url('upload/product/' . $product->image_link) ?>" style="height: 110px; width: 100px">
                                ...
                                <div class="left">
                                    ...
                                    <?php if(is_array($image_list)): ?>
                                        <?php foreach ($image_list as $image): ?>
                                            <img src="<?php echo base_url('upload/product/' . $image) ?>" style="height: 110px; width: 100px">
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                    <br><input type="file" id="image_list" name="image_list[]" multiple="">
                                </div>
                                        ...
                                        <?php if(count($catalog->subs) > 0): ?>
                                            <optgroup label="<?php echo $catalog->name; ?>">
                                                <?php foreach ($catalog->subs as $sub): ?>
                                                    <option value="<?php echo $sub->id; ?>" <?php echo ($product->catalog_id == $sub->id) ? 'selected' : ''; ?>><?php echo $sub->name; ?></option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        <?php else: ?>
                                            <option value="<?php echo $catalog->id; ?>" <?php echo ($product->catalog_id == $catalog->id) ? 'selected' : ''; ?> ><?php echo $catalog->name; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <textarea name="gifts" id="param_gifts" rows="4" cols="" style="margin: 0px; height: 50px; width: 368px;">
